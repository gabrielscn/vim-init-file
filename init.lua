-- ================================================================================================
-- title : My neovim init file
-- ================================================================================================

-- theme & transparency
vim.cmd.colorscheme("unokai") -- also good: sorbet, habermax, unokai
...
local function git_branch()
  ...
  if now - last_check > 5000 then
    cached_branch = vim.fn.system("git branch --show-current 2>nul")
    cached_branch = cached_branch:gsub("\n", "")
    last_check = now
  end
